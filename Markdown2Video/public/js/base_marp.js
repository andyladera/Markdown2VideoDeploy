...
const baseUrl = typeof window.BASE_APP_URL !== 'undefined' ? window.BASE_APP_URL : ''; //Determina la URL de la aplicación
document.addEventListener('DOMContentLoaded', function() {
    const editorTextareaMarp = document.getElementById('editor-marp'); //Inicializa
    ...
    // Manejar clics en los botones de generación (PDF, PPT, etc.)Add commentMore actions
