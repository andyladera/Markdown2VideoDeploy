...
export declare class EventManager extends EventEmitter<EventManagerEventsMap> {
    ...
    subscribe(eventNames: ChromiumBidi.EventNames[], contextIds: BrowsingContext.BrowsingContext[], userContextIds: Browser.UserContext[], channel: BidiPlusChannel): Promise<string>;
